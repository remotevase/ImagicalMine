...
namespace pocketmine {
    ...
    const MINECRAFT_VERSION = "v0.15.0.1 alpha- The Friendly Update";
    const MINECRAFT_VERSION_NETWORK = "0.15.0.1";
     ...
     *
     * @param object  $value
     * @param bool    $includeCurrent (optional)
     * @return int
     */
